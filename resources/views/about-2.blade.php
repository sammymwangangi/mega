...
<!-- Mirrored from constructzilla.dexignzone.com/xhtml/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Aug 2019 11:45:48 GMT -->
...
<head>
	...
	<meta name="description" content="This theme is built for construction, building services and architecture with outstanding features. This theme supports RTL language. It is fully responsive and remain its beauty on any device." />
	<meta property="og:title" content="ConstructZilla - Construction Template" />
	<meta property="og:description" content="This theme is built for construction, building services and architecture with outstanding features. This theme supports RTL language. It is fully responsive and remain its beauty on any device." />
	<meta property="og:image" content="og_img/social-image.png" />
...
<div class="page-wraper">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="active"> <a href="javascript:;">Home<i class="fa fa-chevron-down"></i></a>
                                <ul class="sub-menu">
									...
									<li><a href="index-13.html">Home 12  <span class="new-page">New</span></a></li>
                                </ul>
                            </li>
    ...
    <div class="page-content">
        ...
        <div class="clearfix">
							...
							<div class="row">
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
										<div class="icon-bx-sm bg-primary radius"> <a href="#" class="icon-cell"><i class="fa fa-building-o"></i></a> </div>
										<div class="icon-content p-l40">
											<h5 class="aon-tilte text-uppercase">Construction</h5>
								...
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
										<div class="icon-bx-sm bg-primary radius"> <a href="#" class="icon-cell"><i class="fa fa-file-text-o"></i></a> </div>
										<div class="icon-content p-l40">
											<h5 class="aon-tilte text-uppercase">Architecure</h5>
											<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
										<div class="icon-bx-sm bg-primary radius"> <a href="#" class="icon-cell"><i class="fa fa-user"></i></a> </div>
										<div class="icon-content p-l40">
											<h5 class="aon-tilte text-uppercase">Consulting</h5>
											<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
										</div>
									</div>
								</div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
                                    ...
                                    <div class="icon-content p-l40">
                                        <h5 class="aon-tilte text-uppercase">Safety</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
                                    ...
                                    <div class="icon-content p-l40">
                                        <h5 class="aon-tilte text-uppercase">Community</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
                                    ...
                                    <div class="icon-content p-l40">
                                        <h5 class="aon-tilte text-uppercase">Sustainability</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
                                    ...
                                    <div class="icon-content p-l40">
                                        <h5 class="aon-tilte text-uppercase">Best Quality</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="icon-bx-wraper bx-style-2 m-l40 m-b30 p-a30 left">
                                    <div class="icon-bx-sm radius bg-primary m-b20"> <a href="#" class="icon-cell"><i class="fa fa-pencil"></i></a> </div>
                                    <div class="icon-content p-l40">
                                        <h5 class="aon-tilte text-uppercase">Integrity</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="icon-bx-wraper bx-style-2 m-l40 m-b10 p-a30 left">
                                    <div class="icon-bx-sm radius bg-primary m-b20"> <a href="#" class="icon-cell"><i class="fa fa-flag-checkered"></i></a> </div>
                                    <div class="icon-content p-l40">
                                        <h5 class="aon-tilte text-uppercase">Strategy</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod [...]</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="section-full overlay-black-middle bg-img-fix content-inner-1" style="background-image:url(images/background/bg14.jpg);">
                <div class="container">
    ...
    <footer class="site-footer">
        ...
        <div class="bg-primary dez-newsletter">
            <div class="container equal-wraper">
                <form class="dzSubscribe" action="http://constructzilla.dexignzone.com/xhtml/script/mailchamp.php" method="post">
					<div class="row">
...
<script src="plugins/switcher/js/switcher.js"></script><!-- CONTACT JS  -->
