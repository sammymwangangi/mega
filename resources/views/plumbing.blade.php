        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/background/bg11.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Plumbing & Sewerage</h1>
					...
					<div class="col-lg-9 col-md-8 col-sm-6">
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="dez-box">
									<div class="dez-media m-b30 p-b5"> <a href="#"><img src="images/our-services/img1.jpg" alt=""></a> </div>
									<div class="dez-media m-b30"> <a href="#"><img src="images/our-services/pic4.jpg" alt=""></a></div>
								</div>
